...
router.beforeEach((to, from, next) => {
    ...
    if( to.name == 'openRemind' || to.name == 'freeUse' || to.name == 'earnMoney' || to.name == 'personalIndex' || to.name == 'modifydata' || to.name == 'submitPredict' || to.name == 'myview' || to.name == 'myfocus' || to.name == 'mycanyou' || to.name == 'order' || to.name == 'single_caoyouquan' || to.name == 'publish' || to.name == 'orderList' || to.name == 'filter'){
