    ...
    <div class="container">
        ...
        <div style="padding:0.4rem 0.2rem;" v-if="info">
            ...
            <div class="text-center" style="padding:0.4rem 0;">
                <van-button class="orange_btn mian_bgcolor" @click="doCopy(info.invitecontent)">分享内容复制</van-button>
            </div>
            <div class="earn_money_item">
            ...
            <div class="text-center"  style="padding:0.4rem 0;">
                <van-button class="orange_btn mian_bgcolor" @click="go_recommend">我的推荐页</van-button>
            </div>
            <div class="earn_money_item">
            ...
            <div>
                ...
                <van-button class="orange_btn tikuan mian_bgcolor" @click="show_tikuan" :disabled="info.yongjin < info.limitmoney">提 款</van-button>
            </div>
