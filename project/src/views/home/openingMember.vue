<template>
    <div>
        ...
        <div class="simulate_rules">
            ...
            <p  v-for="(dom,i) in shuomingList" :key="i" :class="shuomingList.length-1 == i?'goldcoins_fans':''">{{dom}} <van-button v-if="shuomingList.length-1 == i" class="orange_btn mian_bgcolor" round @click="jumpTo('/personal/freeUse')" style="white-space:nowrap;">免费获取</van-button></p>
        ...
        <van-button class="mian_bgcolor" size="large" style="background:#FC7953;color:#fff" @click="toPay">开通会员</van-button>
    </div>
</template>
